  ...
  return (
    <li className="flex gap-2.5 items-center">
      <div className="relative flex items-center">
        <input
          className="h-4 w-4 rounded appearance-none border-2 checked:bg-amber-500 checkbox-custom"
          type="checkbox"
          checked={checked}
          onChange={onChange}
        />
    ...
    <li className="flex gap-2.5 items-center">
      <div className="relative flex items-center text-sm">
        <label htmlFor={value} className="">
          <input
            className="h-4 w-4 rounded appearance-none border-2 checked:bg-amber-500 checkbox-custom mr-3"
            type="radio"
            id={value}
            checked={checked}
            onChange={onChange}
...
const ListFilter = ({ id, items }: ListFilterProps) => {
  return (
    <ul id={id} className="flex flex-col gap-2 text-sm">
...
const Filter = ({ onApplyFilters }: FilterSidebarProps) => {
  ...
  return (
    <form className="flex flex-col" action="">
      <div className="flex justify-between mb-6">
        <div>Filter</div>
        <button className="text-amber-500" type="reset" onClick={handleReset}>
          Reset Filter
        </button>
      </div>
      ...
      <label className="font-bold my-2" htmlFor="sort-by">
        Sort By
      </label>
