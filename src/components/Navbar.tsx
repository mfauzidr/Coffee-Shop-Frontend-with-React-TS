...
import { SignButton, ProfileButton, LogoutButton, CartButton } from "./Buttons";
...
const Navbar = ({ bgColor, position }: NavbarProps) => {
  ...
  return (
    <nav
      id="navbar"
      className={`flex flex-col lg:flex-row lg:h-20 w-full ${bgColor} text-white items-center px-8 md:px-16 lg:px-32 gap-4 lg:gap-0 py-6 lg:py-0 ${position} overflow-hidden ${
