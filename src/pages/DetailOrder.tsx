        ...
        <>
            ...
            <div className="flex flex-col mx-16 lg:mx-32 mt-8 lg:mt-16 h-auto gap-5">
                <div className="flex flex-col w-full gap-2.5">
                    <h1 className="text-2xl lg:text-5xl font-medium">Order <span className="font-bold">#12354-09893</span></h1>
                    <div className="text-sm lg:text-base text-gray-600">21 March 2023 at 10:30 AM</div>
                </div>
                <div className="flex flex-col lg:flex-row gap-5">
                    <div className="flex-1 flex-col ">
                        <div className="flex justify-between items-center h-fit mb-3.5">
                            <div className="text-base lg:text-xl font-medium">Order Information</div>
                        </div>
                    ...
                    <div className="flex flex-1 flex-col gap-2.5 mb-10">
                        <div className="flex justify-between items-center h-fit mb-3.5">
                            ...
                            <button className="w-20 md:w-28 h-8 md:h-10 border border-amber-500 rounded-md bg-amber-500 font-semibold text-xs md:text-sm"
